...
function action_process_callback($form_data) {
		$data = file_get_contents('education.json');
		$data_array = json_decode($data);
		...
		//return to json and put contents to our file
		$data_array = json_encode($data_array, JSON_PRETTY_PRINT);
		file_put_contents('education.json', $data_array);
};

add_action('trollol','action_process_callback',10);
//--------------------------------------------------------//
function action_process_callback1($form_data) {
        $data = file_get_contents('ResumeForm.json');
        $data_array = json_decode($data);
...
'percentage' => $percentage
        ...
        //return to json and put contents to our file
        $data_array = json_encode($data_array, JSON_PRETTY_PRINT);
        file_put_contents('ResumeForm.json', $data_array);
};

add_action('ResumeForm','action_process_callback1');
//--------------------------WEBSERVICE--------------------------------------//
add_action('wp_enqueue_scripts','startfunction');
